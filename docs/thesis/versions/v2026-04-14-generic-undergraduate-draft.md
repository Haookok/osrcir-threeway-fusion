# 通用本科模板版论文初稿 v2026-04-14

> 说明：本稿基于项目现有实验结果与方法文档整理而成，用于后续迁移到同济大学官方 Word 模板。
> 原始草稿保留在 `docs/thesis/thesis.md`，本文件为独立版本，不覆盖原稿。

---

## 封面信息

- 论文题目：基于视觉代理与描述融合的零样本组合式图像检索方法研究（暂定）
- 英文题目：Research on Zero-Shot Composed Image Retrieval with Visual Proxy and Description Fusion
- 学院：【待填写】
- 专业：【待填写】
- 学生姓名：【待填写】
- 学号：【待填写】
